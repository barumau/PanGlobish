...
puede leer Panglo en voz alta y ser comprendido.

## Alfabeto latino básico

Panglo se escribe en el alfabeto latino básico – ¡la misma que español!
...
Panglo tiene su propio sistema de sonidos y su propio sistema de escribir
...
Panglo tiene cinco vocales orales.
Se escribe y pronuncia en la misma forma que en español en su mayoría.

La siguiente tabla muestra como cada vocal de Panglo se pronuncia
...
Panglo tiene dos semivocales **y** y **v**.
...
Panglo tiene diecinueve consonantes.
...
La tabla siguiente demostra cómo cada consonante de Panglo se pronuncia
usando los símbolos del Alfabeto Fonético Internacional (AFI)
...
que no pertenecen al vocabulario básico de Panglo, como nombres de ubicaciónes y personas.
No se usan en palabras de uso común en Panglo.
...
La versión de Panglo de este nombre es "Athina".
...
Palabras de Panglo son estructuralmente algo simple.
...
Normalmente, Panglo se escribe solo con minúsculas.
...
Pero por todas formas mayúsculas no son necesarias, y no se recomendan en Panglo.
